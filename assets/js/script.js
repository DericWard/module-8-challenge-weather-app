    ...
    let card0Temp = document.getElementById("card0"); // tomorrow
    let card0WindSpeed = document.getElementById("card0"); // tomorrow
    let card0Humidity = document.getElementById("card0"); // tomorrow

    let card1Temp = document.getElementById("card1-temp"); // day after tomorrow
    let card1WindSpeed = document.getElementById("card1-wind"); // day after tomorrow
    let card1Humidity = document.getElementById("card1-humidity"); // day after tomorrow
    
    let card2Temp = document.getElementById("card2-temp"); // etc
