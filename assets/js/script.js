    ...
    let card2Date = document.getElementById("card2-date"); //
    ...
    let card3Date = document.getElementById("card3-date"); //
    ...
    let card4Date = document.getElementById("card4-date"); //
    ...
    let card5Date = document.getElementById("card5-date"); //
    ...
    let K = 273.15; // c = K - 273.15 kelvin to centigrade
    let todaysDate = moment();
    // incrementDate = todaysDate.add(1, 'd').format("DD/M/YYYY");
    let searchCity = "";
    let queryLatLon = "";
    let queryURL = "";
        ...
        $.ajax({
            ...
            method: "GET"
                ...
                for(let i = 4; i < 37; i+= 8) {
                    let day = {
                    // temp: Math.round(response.list[i].main.temp - K),
                ...
                card3Date.textContent = todaysDate.add(1, 'd').format("DD/M/YYYY");
                ...
                card4Date.textContent = todaysDate.add(1, 'd').format("DD/M/YYYY");
                ...
                card5Date.textContent = todaysDate.add(1, 'd').format("DD/M/YYYY");;
    ...
    $("#search-button").on("click", function() {
        ...
        // console.log(todaysDate.add(1, 'd').format("DD/MM/YYYY"));
        // console.log(moment(todaysDate, "DD/MM/YYYY"));
        $.ajax({
            url: queryLatLon,
            method: "GET"
            }).then(function(response) {
